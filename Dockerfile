...
CMD sh -c "python manage.py migrate && \
           ...
           python -c 'import gevent; print(gevent.__version__)' && gunicorn internship_portal.wsgi:application --bind 0.0.0.0:$PORT --worker-class gthread --workers 8 --threads 8 --timeout 60"
